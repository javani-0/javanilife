        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5 max-[height:760px]:space-y-2 max-[height:560px]:space-y-1.5 sm:space-y-3">
            ...
            <label className="block">
              ...
              />
              <p className="mt-1 font-body text-[0.72rem] text-muted-foreground max-[height:760px]:text-[0.67rem] max-[height:560px]:text-[0.62rem]">
                Used for order & course updates. You can change this anytime in Account Details.
              </p>
            </label>
